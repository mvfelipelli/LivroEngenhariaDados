---
title: Python
description: "Programação Python aplicada à automação, integração e engenharia de dados."
...
2. Tipos, Controle de Fluxo e Coleções — planejado.
...
```mermaid
flowchart LR
    A["Linguagem"] --> B["Código confiável"]
    B --> C["Integrações"]
    C --> D["Processamento"]
    D --> E["Pipelines operáveis"]
```
