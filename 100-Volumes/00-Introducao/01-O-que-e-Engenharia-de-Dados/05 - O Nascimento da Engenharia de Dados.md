...
Ela não surgiu porque alguém criou o [[Apache Spark]].

Também não nasceu com o Hadoop, o [[Data Lake]] ou a computação em nuvem.
...
Essa mudança aproximou definitivamente a [[Engenharia de Dados]] da [[Engenharia de Software]].
...
- o [[Apache Spark]] pode processar grandes volumes;
...
O [[Apache Spark]] teve papel importante na consolidação da Engenharia de Dados moderna.
...
O objetivo do Lakehouse é combinar características do [[Data Warehouse]] com a flexibilidade do Data Lake.
...
Tecnologias como [[Apache Iceberg]], Delta Lake e Apache Hudi passaram a fornecer recursos de gerenciamento de tabelas sobre armazenamento de objetos.
...
Ferramentas de orquestração, como o [[Apache Airflow]], passaram a controlar:
...
A [[Qualidade de Dados]] pode envolver dimensões como:
...
Na próxima parte deste capítulo veremos como conceitos como [[DataOps]], [[Computação em Nuvem]], [[Apache Spark]], [[Lakehouse]] e [[Inteligência Artificial]] consolidaram definitivamente a Engenharia de Dados como uma disciplina própria da computação.
