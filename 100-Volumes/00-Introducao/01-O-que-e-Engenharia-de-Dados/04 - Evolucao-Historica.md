...
Entender essa evolução é fundamental para compreender por que utilizamos hoje ferramentas como [[Apache Spark]], [[Apache Airflow]], [[Trino]], [[Apache Iceberg]] e [[PostgreSQL]].
...
Para resolver o problema da fragmentação dos dados surgiu o conceito de [[Data Warehouse]].
...
Em resposta às limitações do Hadoop, surgiu o [[Apache Spark]].
